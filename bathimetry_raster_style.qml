...
<qgis version="3.4.5-Madeira" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="1e+08">
  ...
  <pipe>
    <rasterrenderer opacity="1" angle="35" alphaBand="-1" band="1" zfactor="1" type="hillshade" azimuth="108" multidirection="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
    ...
    <huesaturation colorizeBlue="128" colorizeOn="0" grayscaleMode="0" colorizeRed="255" colorizeGreen="128" colorizeStrength="100" saturation="0"/>
